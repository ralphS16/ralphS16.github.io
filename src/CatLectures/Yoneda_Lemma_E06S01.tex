...
\begin{exmps}
	\begin{enumerate}
		...
		\begin{figure}[h]
			\centering
			\begin{tikzcd}
				H^{\mathbf{1}}(B) \arrow[d] \arrow[r, "f\circ (-)"] & H^{\mathbf{1}}(B') \arrow[d] \\
...
\begin{exmps}
	...
	\begin{enumerate}
		...
		\begin{figure}[h]
			\centering
			\begin{tikzcd}
				H_{\mathbf{2}}(X) \arrow[d] \arrow[r, "f\circ (-)"] & H_{\mathbf{2}}(Y) \arrow[d] \\
...
\begin{proof}
	...
	\begin{figure}[H]
		\centering
		\begin{tikzcd}
			{\Nat(H^A,F)} \arrow[d, "\mu \cdot (-) \cdot H^g"'] \arrow[r, "{\phi_{A,F}}"] & F(A) \arrow[d, "F'(g) \circ \mu_A"] \\
